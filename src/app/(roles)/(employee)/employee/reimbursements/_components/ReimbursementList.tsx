...
export function ReimbursementList({
  reimbursements, isLoading, page, totalPages,
  handleDelete, fetchReimbursements
                    ...
                    {rmb.receiptUrl && (
                      <div className="flex-1">
                        {rmb.receiptUrl.match(/\.(jpeg|jpg|gif|png|webp|avif)$/i) ? (
                          ...
                          >
                            <img src={rmb.receiptUrl} alt="Receipt Preview" className="w-full h-full object-cover transition-transform duration-500 group-hover/img:scale-110" />
