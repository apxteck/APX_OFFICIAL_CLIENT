...
export function ProfileForm({
  user, fullName, setFullName, phone, setPhone, handleSubmit, isSubmitting, successMessage
}: ProfileFormProps) {
  return (
    <motion.div variants={item} className="bg-white dark:bg-[#111] p-5 sm:p-6 md:p-8 rounded-2xl md:rounded-3xl border border-gray-100 dark:border-white/5 shadow-sm space-y-6">
