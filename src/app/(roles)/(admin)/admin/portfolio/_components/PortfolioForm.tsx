          ...
          <div className="bg-[#111] p-6 rounded-3xl border border-white/5 space-y-5">
            <div>
              ...
              <input
                ...
                className="w-full bg-[#1a1a1a] border border-white/10 rounded-xl px-4 py-3 min-h-[44px] text-white focus:border-[#39FF14] outline-none transition-colors"
          ...
          <div className="bg-[#111] p-6 rounded-3xl border border-white/5 space-y-5">
            ...
            <div>
              ...
              <input
                ...
                onChange={logic.handleChange}
                className="w-full bg-[#1a1a1a] border border-white/10 rounded-xl px-4 py-3 min-h-[44px] text-white outline-none"
              />
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={logic.handleChange}
                  className="w-full bg-[#1a1a1a] border border-white/10 rounded-xl pl-10 pr-4 py-3 min-h-[44px] text-white outline-none"
                  placeholder="https://"
                />
              </div>
            </div>
          ...
          <div className="bg-[#111] p-6 rounded-3xl border border-white/5 space-y-5">
            <div>
              ...
              <input
                ...
                className="w-full min-h-[44px] text-sm text-gray-400 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:bg-white/10 file:text-white hover:file:bg-white/20"
              />
            </div>
            <div>
