...
export default function ServicesError({
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[400px] bg-white dark:bg-[#111111] rounded-3xl border border-red-100 dark:border-red-900/30 p-8 text-center max-w-4xl mx-auto mt-6">
      ...
      <p className="text-gray-500 dark:text-gray-400 text-sm max-w-md mx-auto mb-6">
        {error.message || 'An unexpected error occurred while fetching services. Please try again.'}
      </p>
      <button
        onClick={reset}
