...
export function CompanyAssetCard({ asset, onEdit, onDelete }: CompanyAssetCardProps) {
  ...
  return (
    <div className={`bg-white dark:bg-[#1A1A1A] p-5 rounded-2xl border ${isExpiringSoon ? 'border-red-500/30 dark:border-red-500/30 shadow-[0_0_15px_rgba(239,68,68,0.1)]' : 'border-gray-100 dark:border-white/5'} shadow-sm hover:shadow-md transition-all group flex flex-col`}>
