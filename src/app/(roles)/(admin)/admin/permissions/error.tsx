...
export default function PermissionsError({
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[400px] bg-white dark:bg-[#111111] rounded-3xl border border-red-100 dark:border-red-900/30 p-8 text-center max-w-6xl mx-auto mt-6">
