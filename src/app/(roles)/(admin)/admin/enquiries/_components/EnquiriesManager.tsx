          ...
          {isLoading ? (
            <div className="min-h-[400px] flex items-center justify-center">
              <div className="flex flex-col items-center gap-3">
                ...
                <p className="text-sm font-medium text-gray-500 dark:text-gray-400">Loading enquiries...</p>
              </div>
            </div>
          ) : enquiries.length > 0 ? (
            <DataTable 
            ...
            <div className="min-h-[400px] flex flex-col items-center justify-center p-8 text-center">
              ...
              <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-2">No enquiries found</h3>
