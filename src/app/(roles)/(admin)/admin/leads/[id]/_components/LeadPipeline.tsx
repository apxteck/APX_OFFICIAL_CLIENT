      ...
      {isLost ? (
        ...
        <div className="flex items-center justify-between relative overflow-hidden px-4">
          ...
          <div
            ...
            style={{
              width: `${Math.max(0, (activeStageIndex / (PIPELINE_STAGES.length - 1)) * 100)}%`,
            }}
          ></div>
          ...
          {PIPELINE_STAGES.map((stage, idx) => {
            ...
            return (
              ...
              >
                <div
                  className={`w-12 h-12 rounded-full flex items-center justify-center border-4 border-white dark:border-[#111111] transition-all duration-300 ${
                    isActive
