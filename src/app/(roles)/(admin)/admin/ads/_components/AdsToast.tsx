...
export function AdsToast({ message, type, onClose }: ToastProps) {
  useEffect(() => {
  ...
  return (
    <div
      className={`fixed bottom-4 right-4 z-[9999] px-4 py-3 rounded-xl border shadow-lg flex items-center gap-3 animate-in slide-in-from-bottom-5 ${bg}`}
    >
