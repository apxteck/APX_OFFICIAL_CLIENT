...
import { ArrowLeft, Mail, Monitor, ShieldAlert } from 'lucide-react';
    ...
    <motion.div variants={container} initial="hidden" animate="show" className="max-w-3xl mx-auto space-y-8 pb-12">
      ...
      <motion.div variants={item} className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-gray-500 dark:text-gray-400 mt-1">Manage admin alerts and system notifications.</p>
        </div>
      </motion.div>
