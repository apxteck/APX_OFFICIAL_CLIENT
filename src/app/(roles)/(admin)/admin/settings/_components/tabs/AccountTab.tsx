    ...
    <div className="bg-white dark:bg-[#111] rounded-3xl border border-gray-100 dark:border-white/5 shadow-sm overflow-hidden">
      ...
      <div className="p-6 space-y-8 min-h-[400px]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
          <Link href="/admin/settings/security" className="bg-gray-50 dark:bg-[#151515] p-6 rounded-3xl border border-gray-100 dark:border-white/5 shadow-sm hover:border-indigo-500/30 transition-all cursor-pointer group flex flex-col justify-between h-[200px]">
            <div>
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400 mt-2">Update your password and secure your account.</p>
            </div>
          ...
          <Link href="/admin/settings/notifications" className="bg-gray-50 dark:bg-[#151515] p-6 rounded-3xl border border-gray-100 dark:border-white/5 shadow-sm hover:border-amber-500/30 transition-all cursor-pointer group flex flex-col justify-between h-[200px]">
            <div>
              <div className="flex items-center gap-3 mb-2">
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400 mt-2">Manage how you receive updates and alerts.</p>
            </div>
