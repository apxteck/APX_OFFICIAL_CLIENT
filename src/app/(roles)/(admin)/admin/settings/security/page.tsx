  ...
  return (
    <motion.div variants={container} initial="hidden" animate="show" className="max-w-3xl mx-auto space-y-8 pb-12">
      ...
      <motion.div variants={item} className="flex items-center gap-4">
        <Link href="/admin/settings" className="p-2 rounded-xl bg-white dark:bg-[#111] border border-gray-100 dark:border-white/5 hover:border-cyan-500/30 text-gray-500 hover:text-cyan-500 transition-all">
          <ArrowLeft className="w-5 h-5" />
        </Link>
        <div>
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Security Settings</h1>
          <p className="text-gray-500 dark:text-gray-400 mt-1">Update your admin password to keep the platform secure.</p>
        </div>
      </motion.div>
      ...
      <motion.div variants={item} className="bg-white dark:bg-[#111] p-6 md:p-8 rounded-3xl border border-gray-100 dark:border-white/5 shadow-sm space-y-8">
        ...
        <form className="space-y-6">
          ...
          <div className="pt-4 flex items-center gap-4">
            ...
            <Link href="/admin/settings" className="text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200 font-bold px-4 py-3 transition-colors">
              Cancel
            </Link>
          </div>
        </form>
        ...
        <div className="bg-indigo-500/5 border border-indigo-500/10 rounded-2xl p-4 flex gap-3 mt-8">
          ...
          <div className="space-y-1">
             <p className="text-sm font-bold text-indigo-700 dark:text-indigo-400">Admin Password Requirements</p>
