    ...
    <motion.div variants={item} className="bg-white dark:bg-[#111] p-6 md:p-8 rounded-3xl border border-gray-100 dark:border-white/5 shadow-sm space-y-8">
      ...
      <form onSubmit={handleUpdate} className="space-y-6">
        ...
        <div className="pt-4 flex items-center gap-4">
          <button type="submit" className="bg-indigo-500 hover:bg-indigo-400 text-white font-bold px-8 py-3 min-h-[44px] flex items-center justify-center rounded-xl shadow-[0_0_20px_rgba(99,102,241,0.3)] transition-all active:scale-[0.98]">
            Update Password
          </button>
          <Link href="/admin/settings" className="text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200 font-bold px-4 py-3 min-h-[44px] flex items-center justify-center transition-colors">
            Cancel
          </Link>
        </div>
      </form>
