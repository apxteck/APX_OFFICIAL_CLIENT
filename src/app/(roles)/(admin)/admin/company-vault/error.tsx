...
export default function CompanyVaultError({
  ...
  useEffect(() => {
    console.error('Company Vault Error:', error);
  }, [error]);

  return (
    <div className="flex flex-col items-center justify-center min-h-[400px] bg-white dark:bg-[#111111] rounded-3xl border border-red-100 dark:border-red-900/30 p-8 text-center max-w-7xl mx-auto">
      ...
      <p className="text-gray-500 dark:text-gray-400 text-sm max-w-md mx-auto mb-6">
        {error.message || 'Failed to load company vault documents. Please try again.'}
      </p>
      <button
        onClick={reset}
