    ...
    <div className="space-y-6 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 font-medium mt-2">
            Ad slots and active campaign management.
          </p>
        </div>
      </div>
      ...
      >
        ...
        <p className="text-gray-500 dark:text-gray-400 text-sm max-w-md mx-auto leading-relaxed">
          The <strong>Advertisements</strong> frontend routing is active, but the backend APIs and data tables have not been connected yet. 
        </p>
