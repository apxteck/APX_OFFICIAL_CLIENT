...
export function InvoiceModal({ request, invoicePayment, user, onClose }: InvoiceModalProps) {
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h2 className="text-lg font-bold text-gray-900 tracking-tight">
                      Invoice{' '}
                      <span className="text-gray-400 font-medium">#INV-{invoicePayment.id}</span>
                    </h2>
                  </div>
                </div>
                  ...
                  <div className="text-left sm:text-right w-full sm:w-auto flex flex-col justify-between">
                    ...
                    <div className="space-y-1.5 mt-auto sm:text-right">
                      <p className="text-sm font-semibold text-gray-900 flex justify-between sm:justify-end gap-4">
                        ...
                        <span className="text-gray-500 font-medium">INV-{invoicePayment.id}</span>
                      </p>
                      <p className="text-sm font-semibold text-gray-900 flex justify-between sm:justify-end gap-4">
                        <span>Date Issued:</span>{' '}
                        <span className="text-gray-500 font-medium">
                          {invoicePayment.paidAt
                            ? format(new Date(invoicePayment.paidAt), 'MMM dd, yyyy')
                            : format(new Date(invoicePayment.createdAt), 'MMM dd, yyyy')}
                        </span>
                      </p>
                      <p className="text-sm font-semibold text-gray-900 flex justify-between sm:justify-end gap-4">
