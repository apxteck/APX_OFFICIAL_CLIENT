...
import { ArrowLeft, Loader2, Edit2, XCircle, Save, CheckCircle2, AlertCircle, Clock } from 'lucide-react';
  ...
  return (
    <motion.div variants={item} className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 bg-white dark:bg-[#111] p-6 md:p-8 rounded-3xl border border-gray-100 dark:border-white/5 shadow-sm">
      <div className="flex items-start gap-4">
        <Link href="/customer/requests" className="mt-1 p-2 rounded-xl bg-gray-50 dark:bg-white/5 hover:bg-gray-100 dark:hover:bg-white/10 text-gray-500 transition-all min-w-[44px] min-h-[44px] flex items-center justify-center">
