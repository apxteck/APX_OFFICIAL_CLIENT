  ...
  return (
    <motion.div variants={item} className="lg:col-span-2 bg-white dark:bg-[#111] p-6 md:p-8 rounded-3xl border border-gray-100 dark:border-white/5 shadow-sm space-y-6">
      <div className="flex items-center justify-between">
        ...
        <Link href="/customer/requests" className="hidden sm:flex items-center justify-center min-h-[44px] gap-1 text-sm font-bold text-cyan-600 dark:text-cyan-400 hover:text-cyan-700 dark:hover:text-cyan-300 transition-colors">
          <span>View All</span>
      ...
      <Link href="/customer/requests" className="sm:hidden w-full flex items-center justify-center min-h-[44px] gap-2 py-3 mt-2 rounded-xl bg-gray-50 dark:bg-white/5 text-sm font-bold text-gray-900 dark:text-white border border-gray-100 dark:border-white/5">
