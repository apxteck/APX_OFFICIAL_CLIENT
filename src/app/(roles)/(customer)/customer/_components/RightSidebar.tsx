    ...
    <motion.div variants={item} className="space-y-6">
      ...
      <div className="bg-gradient-to-br from-cyan-600 to-indigo-700 p-6 md:p-8 rounded-3xl text-white shadow-lg relative overflow-hidden group">
        ...
        <div className="relative z-10 space-y-4">
          ...
          <Link href="/contact" className="w-full py-3 min-h-[44px] rounded-xl bg-white text-cyan-700 hover:bg-cyan-50 font-bold text-sm flex items-center justify-center gap-2 shadow-lg hover:shadow-xl active:scale-[0.98] transition-all cursor-pointer">
      ...
      <div className="bg-white dark:bg-[#111] p-6 md:p-8 rounded-3xl border border-gray-100 dark:border-white/5 shadow-sm space-y-4">
        ...
        <div className="grid grid-cols-2 gap-3">
          <Link href="/customer/payments" className="flex flex-col items-center justify-center gap-2 p-4 min-h-[44px] rounded-2xl bg-gray-50 dark:bg-[#1a1a1a] hover:bg-cyan-50 dark:hover:bg-cyan-500/10 border border-transparent hover:border-cyan-200 dark:hover:border-cyan-500/30 transition-all text-center group">
          ...
          <Link href="/customer/requests" className="flex flex-col items-center justify-center gap-2 p-4 min-h-[44px] rounded-2xl bg-gray-50 dark:bg-[#1a1a1a] hover:bg-indigo-50 dark:hover:bg-indigo-500/10 border border-transparent hover:border-indigo-200 dark:hover:border-indigo-500/30 transition-all text-center group">
