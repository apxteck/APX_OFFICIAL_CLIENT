...
export default function NewServiceManager({ initialServices }: NewServiceManagerProps) {
  ...
  return (
    <motion.div variants={container} initial="hidden" animate="show" className="w-full max-w-4xl mx-auto space-y-8 px-4 sm:px-6 md:px-8 pt-4 pb-safe">
      {/* Header */}
      <motion.div variants={item} className="flex items-center gap-4">
        <Link href="/customer/services" className="p-2 rounded-xl bg-white dark:bg-[#111] border border-gray-100 dark:border-white/5 hover:border-cyan-500/30 text-gray-500 hover:text-cyan-500 transition-all flex items-center justify-center min-w-[44px] min-h-[44px]">
