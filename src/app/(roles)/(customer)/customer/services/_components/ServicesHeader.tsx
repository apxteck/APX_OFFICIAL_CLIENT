...
export function ServicesHeader() {
  ...
  return (
    <motion.div variants={item} className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
      ...
      <Link href="/customer/services/new" className="flex items-center justify-center min-h-[44px] gap-2 bg-cyan-500 hover:bg-cyan-600 text-black font-bold px-5 py-2.5 rounded-xl shadow-[0_0_15px_rgba(6,182,212,0.3)] transition-all">
