  ...
  return (
    <div className="min-h-[400px] flex items-center justify-center p-6">
      <div className="bg-white dark:bg-[#111111] border border-red-100 dark:border-red-500/20 rounded-3xl p-8 max-w-md w-full text-center shadow-sm">
        ...
        <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-2">Failed to load services</h2>
        <p className="text-gray-500 dark:text-gray-400 text-sm mb-8">
          There was a problem loading your active services. Please try again or contact support if the issue persists.
        </p>
        <button
          onClick={() => reset()}
