...
export function AboutStory() {
  return (
    <section className="py-16 md:py-24 max-w-7xl mx-auto px-4 sm:px-6 relative w-full overflow-hidden" aria-labelledby="about-story-heading">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-16 items-center w-full">
        ...
        >
          ...
          <h2 id="about-story-heading" className="text-3xl sm:text-4xl md:text-5xl font-extrabold tracking-tight leading-tight w-full">
        ...
        <div className="relative w-full order-1 lg:order-2">
          ...
          >
            ...
            >
              ...
              <div className="text-xs sm:text-sm font-semibold text-foreground/80">In-house Engineering Team</div>
