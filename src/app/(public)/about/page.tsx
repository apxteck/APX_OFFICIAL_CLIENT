    ...
    <div className="flex flex-col min-h-screen selection:bg-accent/30 bg-background text-foreground transition-colors duration-300">
      ...
      <main className="flex-1 pt-24">
        ...
        <section className="relative py-24 overflow-hidden flex items-center justify-center">
          <div
            className="absolute inset-0 bg-cover bg-center -z-20 opacity-30"
            style={{
              backgroundImage:
          ...
          <div className="max-w-7xl mx-auto px-6 relative z-20 text-center space-y-6">
            ...
            <p className="text-foreground/70 max-w-2xl mx-auto text-lg md:text-xl">
              We design and build next-generation web portals and automated systems, helping Indian
              SMBs achieve digital scale.
            </p>
          </div>
        </section>
          ...
          <div className="grid lg:grid-cols-12 gap-12 items-center">
            <div className="lg:col-span-6 space-y-6">
              ...
              <p className="text-foreground/75 leading-relaxed text-base">
                Founded in 2026, APXTeck was established to bridge the gap between expensive global
                software consultancies and standard local web developers. We believed that growing
                Indian small and medium businesses deserved custom, secure, and beautiful products
                without paying massive enterprise licensing bills.
              </p>
              <p className="text-foreground/75 leading-relaxed text-base">
                We started as a lean engineering studio in Pune. Today, we work as strategic design
                and system partners for brands across the country, building Next.js web
            ...
            <div className="lg:col-span-6">
              <GlassCard className="p-8 border border-glass-border shadow-xl">
                ...
                <p className="text-foreground/70 leading-relaxed text-sm mb-6">
                  ...
                  businesses, making high-speed, secure, and beautiful visual experiences accessible
                  to every Indian entrepreneur.
                </p>
                <div className="h-px bg-glass-border w-full my-6" />
                <h3 className="text-2xl font-bold tracking-tight mb-4 text-purple-400">
                  Our Vision
                </h3>
                <p className="text-foreground/70 leading-relaxed text-sm">
                  To become the leading digital engineering partner for SMBs in India, recognized
                  for modern designs, modular codebases, and clear, transparent client
                  relationships.
                </p>
              </GlassCard>
            </div>
            ...
            <div className="p-8 rounded-3xl bg-foreground/[0.01] border border-glass-border flex gap-4">
              ...
              <div className="space-y-2">
                ...
                <p className="text-foreground/70 text-sm leading-relaxed">
                  {"We don't build standard generic templates."} Every layout, route structure, and
                  dynamic data query is mapped precisely to solve a concrete business goal.
                </p>
              </div>
            </div>
            <div className="p-8 rounded-3xl bg-foreground/[0.01] border border-glass-border flex gap-4">
              ...
              <div className="space-y-2">
                ...
                <p className="text-foreground/70 text-sm leading-relaxed">
                  By employing TypeScript, Nest/Next.js frameworks, and clean Prisma schemas, we
                  provide a code setup that is structured and easy to scale as your operations grow.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="py-24 max-w-7xl mx-auto px-6">
          <div className="text-center mb-16 space-y-4">
            ...
            <p className="text-foreground/60 max-w-xl mx-auto">
              These fundamental operating guidelines direct how we write code, design interfaces,
              ...
              return (
                ...
                >
                  <div
                    ...
                    style={{
                      background: `linear-gradient(135deg, ${val.color}, rgba(0,0,0,0.15))`,
                    }}
                  >
