...
export async function generateMetadata(): Promise<Metadata> {
  return {
    ...
    description: 'Securely verify your email address to unlock full access to APXTeck web development and IT services. Completing verification ensures top-level security.',
    robots: {
      index: false,
    ...
    openGraph: {
      title: 'Verify Your Email | APXTeck',
      description: 'Securely verify your email address to unlock full access to APXTeck web development and IT services.',
...
export default function VerifyEmailPage() {
  const jsonLd = {
    ...
    description: 'Email verification page for APXTeck to secure user accounts and unlock premium IT and web development features.',
    url: 'https://apxteck.com/verify-email',
    publisher: {
      '@type': 'Organization',
      name: 'APXTeck',
