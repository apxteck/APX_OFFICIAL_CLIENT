...
export const metadata: Metadata = {
  ...
  description: "APXTeck provides premium IT services, Next.js web development, custom UI/UX, and search engine optimization custom tailored to scale Indian SMBs.",
  openGraph: {
    title: "APXTECK — IT Services for Indian SMBs",
    description: "APXTeck provides premium IT services, Next.js web development, custom UI/UX, and search engine optimization custom tailored to scale Indian SMBs.",
...
export default function Home() {
  const jsonLdOrg = {
    ...
    "sameAs": [
      ...
      "https://linkedin.com/company/apxteck"
    ]
  };
