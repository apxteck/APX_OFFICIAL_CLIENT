...
export const mockCustomerKPIs: KPIData[] = [
  { title: "Total Customers", value: "1,248", trend: "up", percentage: 12, sparklineData: [4, 6, 8, 12, 14, 18, 20] },
  { title: "New Requests (Today)", value: "24", trend: "up", percentage: 5, sparklineData: [2, 5, 3, 8, 4, 10, 24] },
...
export const mockRevenueKPIs: KPIData[] = [
  ...
  { title: "Revenue This Month", value: "₹8,50,000", trend: "up", percentage: 22, sparklineData: [30, 40, 35, 50, 45, 60, 85] },
...
export const mockContentKPIs: KPIData[] = [
  ...
  { title: "Total Blog Likes", value: "12.4K", trend: "up", percentage: 8, sparklineData: [100, 150, 120, 200, 180, 250, 300] }
];

export const mockLeadsKPIs: KPIData[] = [
  { title: "New Leads (This Week)", value: "56", trend: "up", percentage: 14, sparklineData: [5, 8, 6, 12, 10, 15, 20] },
...
export const activityFeed = [
  { id: 1, type: "request", text: "New service request submitted by Rahul Sharma", time: "5 mins ago", icon: "Headset", color: "blue" },
  { id: 2, type: "payment", text: "Payment of ₹45,000 received from TechFlow Solutions", time: "15 mins ago", icon: "CreditCard", color: "green" },
  { id: 3, type: "lead", text: "Lead Amit Kumar status changed to INTERESTED by Sales Agent 1", time: "1 hour ago", icon: "TrendingUp", color: "purple" },
  { id: 4, type: "enquiry", text: "New enquiry received from contact@designstudio.in", time: "2 hours ago", icon: "HelpCircle", color: "orange" },
  { id: 5, type: "blog", text: "Blog post '10 UI Trends 2024' published by Editor Desk", time: "4 hours ago", icon: "FileText", color: "indigo" },
  { id: 6, type: "task", text: "Task 'Fix Server CORS' marked COMPLETED by Dev Team", time: "6 hours ago", icon: "CheckCircle", color: "green" },
  { id: 7, type: "request", text: "Service request #4092 assigned to Support Agent 3", time: "8 hours ago", icon: "UserPlus", color: "blue" },
  { id: 8, type: "reimbursement", text: "Reimbursement of ₹2,500 submitted by Sales Agent 2", time: "1 day ago", icon: "Receipt", color: "yellow" },
  { id: 9, type: "ad", text: "New Ad Campaign 'Summer Sale' launched successfully", time: "1 day ago", icon: "Monitor", color: "pink" },
  { id: 10, type: "payment", text: "Invoice #INV-2041 sent to Client Alpha", time: "1 day ago", icon: "FileText", color: "indigo" }
];
