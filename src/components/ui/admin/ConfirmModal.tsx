...
export default function ConfirmModal({
  ...
  const styles = {
    ...
    info: {
      ...
      button: "bg-indigo-600 hover:bg-indigo-700 text-white shadow-[0_4px_14px_rgba(79,70,229,0.3)]"
    }
  };
            ...
            >
              <div className="p-6">
                <div className="flex justify-between items-start mb-4">
                  <div className={`w-12 h-12 rounded-2xl flex items-center justify-center ${styles[type].bg}`}>
                    {styles[type].icon}
                  </div>
                  <button 
                    onClick={onClose}
