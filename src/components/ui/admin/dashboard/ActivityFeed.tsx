...
const ColorMap: Record<string, string> = {
  ...
  green: "bg-emerald-100/80 text-emerald-600 dark:bg-emerald-500/20 dark:text-emerald-400 border-emerald-200/50 dark:border-emerald-500/30",
  purple: "bg-purple-100/80 text-purple-600 dark:bg-purple-500/20 dark:text-purple-400 border-purple-200/50 dark:border-purple-500/30",
  orange: "bg-orange-100/80 text-orange-600 dark:bg-orange-500/20 dark:text-orange-400 border-orange-200/50 dark:border-orange-500/30",
  indigo: "bg-indigo-100/80 text-indigo-600 dark:bg-indigo-500/20 dark:text-indigo-400 border-indigo-200/50 dark:border-indigo-500/30",
  pink: "bg-pink-100/80 text-pink-600 dark:bg-pink-500/20 dark:text-pink-400 border-pink-200/50 dark:border-pink-500/30",
  yellow: "bg-yellow-100/80 text-yellow-600 dark:bg-yellow-500/20 dark:text-yellow-400 border-yellow-200/50 dark:border-yellow-500/30",
};
  ...
  return (
    <div className="bg-white/80 dark:bg-[#111111]/80 backdrop-blur-xl rounded-[2rem] shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-[0_8px_30px_rgb(0,0,0,0.1)] border border-gray-100/80 dark:border-white/10 flex flex-col min-h-[400px] transition-all duration-300 group hover:shadow-xl hover:border-indigo-100 dark:hover:border-indigo-500/30">
      <div className="p-6 border-b border-gray-100/80 dark:border-white/10 flex items-center justify-between">
        <h2 className="font-extrabold text-gray-900 dark:text-white text-lg group-hover:text-indigo-600 dark:group-hover:text-indigo-400 transition-colors">Recent Activity</h2>
