...
const processSteps = [
  {
    ...
    description:
      'We dive deep into your business requirements, target audience, and goals to craft a tailored digital roadmap.',
    icon: Lightbulb,
    color: '#8b5cf6', // Purple
  },
  {
    ...
    title: 'UI/UX Design',
    description:
      'Our design leads create premium, glassmorphic interfaces focused on conversion and flawless user experience.',
    icon: PenTool,
    color: '#ec4899', // Pink
  },
  {
    ...
    title: 'Engineering',
    description:
      'We build scalable, secure architectures using Next.js, Node.js, and Prisma—engineered for lightning speed.',
    icon: Code2,
    color: '#0ea5e9', // Cyan
  },
  {
    ...
    title: 'Launch & Scale',
    description:
      'We deploy your platform, optimize it for search engines, and provide continuous support to scale your traffic.',
    icon: Rocket,
    ...
    <section className="py-16 md:py-24 relative bg-background overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-24">
          ...
          >
            From raw concept to enterprise-grade execution. We follow a strict, agile methodology
            that guarantees quality at every step.
          </motion.p>
        </div>
          ...
          <div className="space-y-12 md:space-y-24">
            {processSteps.map((step, index) => {
                ...
                >
                  ...
                  <div className="relative rounded-3xl p-[1.5px] overflow-hidden group w-full shadow-2xl">
                    ...
                    <div
                      ...
                      style={{
                        background: `conic-gradient(from 0deg, transparent 0 280deg, ${step.color} 360deg)`,
                      }}
                    />
              ...
              return (
                <div
                  key={step.id}
                  className="relative grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-0 w-full items-center"
                >
                  {/* Left Column */}
                  {!isRightSide ? (
                    <div className="w-full flex md:justify-end md:pr-16">{CardContent}</div>
                  ) : (
                  ...
                  {/* Right Column */}
                  {isRightSide ? (
                    <div className="w-full flex md:justify-start md:pl-16">{CardContent}</div>
                  ) : (
                    <div className="hidden md:block" />
                  )}
                </div>
